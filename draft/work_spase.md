...
Привет, ещё раз скажи, пожалуйста, какие задачи ты сейчас делаешь и какие у тебя в планах, решил писать каждому в личку потому что это надёжный метод держать руку на пульсе, 

Всю собранную информацию буду дублировать и тегать Сергея в чате одним лаконичным сообщением.

Так мы будем безболезненно собирать статус, а на самом статусе просто уточнить его, плюс обсуждать смежные задачи. Без особого замедления процесса.

Если есть предложение как сделать процесс лучше, предлагай. Я пока вижу только этот вариант.
...
у меня есть ещё задачи которые породил дубль зонта, "Работушка мать ее по вечерам", 

Это те самые Баги копи зонта. Я их ещё не решил. Проблема в том что пока я бегал с горящей жопой собирал статус и не понимал откуда берутся задачи по зонту, я слишком поздно заканчивал работать, и на правки копии совершенно не хватало время, Тут ничего страшного просто дурацкая организация работы(Созонта это пока не касается). Чуклин определил правки где-то в 40 часов, Я запросил у тестеров кейсы чтобы оценить это все дело.  Часть проблема уже решилась сама собой (парни решили) по моим скромным ощущениям в самом худшем варианте Учитывая мою загрузку на проекте вместе Баги Копии зонта я отдам тебе через две недели Притом что буду работать по ночам и выходные. 

Если тебя это устроит в таком случае работаем в таком штатном режиме если нет нужно созваниваться




@FrolovSA92 @faith_alhazred добавил новый пункт в задаче связанной с миграцией данных на проде
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237624/


...у реальных пользователей не все пункты меню доступны. Помню в настройках ЛК проставляются программы, нам бы это допилить или отдельную миграцию сделать
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237624/index.php?MID=1898316#com1898316




блокер, комменте указано
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237726/

возврат, спор с Ходоревским
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237546/

@FrolovSA92 пжл на препрод, стало лучше, но баг в рамках задачи остался (возврат)
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237626/

успех, @FrolovSA92 прошу выкатить на препрод
https://inside.notamedia.ru/company/personal/user/4502/tasks/task/view/232396/

успех, @FrolovSA92 пжл выкати на препрод
https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/237638/



привет, подскажи какие задачи делаешь?

Привет, сколько тебе осталось по задаче?

чуклина
- https://inside.notamedia.ru/workgroups/group/5411/tasks/task/view/236472/
...
### отработано (созонт ждем проверку)
