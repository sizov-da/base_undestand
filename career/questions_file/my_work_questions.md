...
### 2. Объясните контексты выполнения и область видимости в JavaScript.
...
### 4. Что такое прототипное наследование и как оно работает в JavaScript?
...
### 8. Как работает асинхронное программирование в JavaScript? Объясните концепции callbacks, promises и async/await.
...
### 9. Что такое event loop в JavaScript и как он работает?
...
### 10. Объясните принцип работы hoisting в JavaScript.
